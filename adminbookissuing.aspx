<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="EducationalOnlineSolution.adminbookissuing" %>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="row">
											<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:EducationalOnlineSolutionDBConnectionString6 %>' SelectCommand="SELECT * FROM [book_issue_tbl]">
											</asp:SqlDataSource>
											<div class="col">
